...
//
//
////m_mainLevels->addObject(GLM->getMainLevel(1001, 0));
////m_mainLevels->addObject(GLM->getMainLevel(1002, 0));
////m_mainLevels->addObject(GLM->getMainLevel(1003, 0));
////m_mainLevels->retain();
...
//pLevels->retain();
//
//pLevels->addObject(GameLevelManager::sharedState()->getMainLevel(10, true));
//pLevels->addObject(GameLevelManager::sharedState()->getMainLevel(11, true));
//pLevels->addObject(GameLevelManager::sharedState()->getMainLevel(12, true));
//
//    //m_levelPages->addObject(node);
//    //m_levelPages->addObject(node2);
//    //m_levelPages->addObject(node3);
//
//   /* static_cast<DynamicScrollDelegate*>(this)*/
//  //  sprite3->setColor(ccBLACK);
//  //  sprite3->setOpacity(40);
//    m_levelPages->retain();
//  m_scrollLayer = BoomScrollLayer::create(pPages, 0, true, pLevels, static_cast<DynamicScrollDelegate*>(this));
//
//
...
//    m_scrollLayer->moveToPage(m_level);
//}
//void LOLwshow2(GJGameLevel* level212) {
//
