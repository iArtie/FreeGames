...
ownWorldSelectLayer* ownWorldSelectLayer::create() {
...
CCScene* ownWorldSelectLayer::scene() {
    auto layer = ownWorldSelectLayer::create();
...
m_scrollLayer = BoomScrollLayer::create(m_levelPages, 0, true, nullptr, static_cast<DynamicScrollDelegate*>(this));
...
//}
void ownWorldSelectLayer::onNext(CCObject* sender) {

    m_level = m_level + 1;
    m_scrollLayer->moveToPage(m_level);
}

void ownWorldSelectLayer::onPrev(CCObject* sender) {
